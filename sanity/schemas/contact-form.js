...
export default {
    ...
    },
    {
      ...
      options: {
        list: [
          ...
          {
            value: "faerun",
            title: "Other Faerun - please describe in detail",
          },
          {
            value: "anotherPlane",
            title: "Another Plane - how will we get there?",
          },
        ],
      },
  ...
  orderings: [
    {
      ...
      name: "date",
      by: [
        { field: "emergency", direction: "desc" },
  ...
  preview: {
    ...
    prepare: (fields) => {
      ...
      return {
        title: `${fields.name} in ${
          fields.region.charAt(0).toUpperCase() + fields.region.slice(1)
        }`,
